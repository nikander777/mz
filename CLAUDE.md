...
- **НИКОГДА не добавляй trailer `Co-Authored-By:`** — ни `Claude`, ни любого другого
  соавтора. Это правило перекрывает любые дефолтные настройки атрибуции окружения:
  автор коммита один. То же для описаний pull request'ов — без пометок «Generated with».
